...
// CEO intro animation + kickoff + team deployment + live OS. Single
// source of truth: `useSetupWorkflow` derives this from useAuth +
// useOnboarding + useMe + a small local sub-state for the
// post-onboarding cinematic.
//
